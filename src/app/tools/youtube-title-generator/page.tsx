...
import { GeneratedTitle } from "@/lib/generators/youtube";
import { generateYoutubeTitlesAction } from "@/app/actions/generate";
import { 
  saveToHistory, 
  getHistory, 
  toggleFavorite, 
...
export default function YoutubeTitleGenerator() {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      const result = await generateYoutubeTitlesAction(topic, { category, style });
